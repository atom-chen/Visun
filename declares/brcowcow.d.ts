...
export namespace brcowcow {
    ...
    /** Properties of a BrcowcowDecideHostResp. */
    interface IBrcowcowDecideHostResp {

        /** BrcowcowDecideHostResp UserID */
        UserID?: (number|Long|null);
    }

    /** Represents a BrcowcowDecideHostResp. */
    class BrcowcowDecideHostResp implements IBrcowcowDecideHostResp {

        /**
         * Constructs a new BrcowcowDecideHostResp.
         * @param [properties] Properties to set
         */
        constructor(properties?: brcowcow.IBrcowcowDecideHostResp);

        /** BrcowcowDecideHostResp UserID. */
        public UserID: (number|Long);

        /**
         * Creates a new BrcowcowDecideHostResp instance using the specified properties.
         * @param [properties] Properties to set
         * @returns BrcowcowDecideHostResp instance
         */
        public static create(properties?: brcowcow.IBrcowcowDecideHostResp): brcowcow.BrcowcowDecideHostResp;

        /**
         * Encodes the specified BrcowcowDecideHostResp message. Does not implicitly {@link brcowcow.BrcowcowDecideHostResp.verify|verify} messages.
         * @param message BrcowcowDecideHostResp message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: brcowcow.IBrcowcowDecideHostResp, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Encodes the specified BrcowcowDecideHostResp message, length delimited. Does not implicitly {@link brcowcow.BrcowcowDecideHostResp.verify|verify} messages.
         * @param message BrcowcowDecideHostResp message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encodeDelimited(message: brcowcow.IBrcowcowDecideHostResp, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a BrcowcowDecideHostResp message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns BrcowcowDecideHostResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): brcowcow.BrcowcowDecideHostResp;

        /**
         * Decodes a BrcowcowDecideHostResp message from the specified reader or buffer, length delimited.
         * @param reader Reader or buffer to decode from
         * @returns BrcowcowDecideHostResp
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): brcowcow.BrcowcowDecideHostResp;

        /**
         * Verifies a BrcowcowDecideHostResp message.
         * @param message Plain object to verify
         * @returns `null` if valid, otherwise the reason why it is not
         */
        public static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
         * Creates a BrcowcowDecideHostResp message from a plain object. Also converts values to their respective internal types.
         * @param object Plain object
         * @returns BrcowcowDecideHostResp
         */
        public static fromObject(object: { [k: string]: any }): brcowcow.BrcowcowDecideHostResp;

        /**
         * Creates a plain object from a BrcowcowDecideHostResp message. Also converts values to other types if specified.
         * @param message BrcowcowDecideHostResp
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: brcowcow.BrcowcowDecideHostResp, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
         * Converts this BrcowcowDecideHostResp to JSON.
         * @returns JSON object
         */
        public toJSON(): { [k: string]: any };
    }
