...
export enum gamecomm_msgs {
    ...
    ChangeTableResp = 35,
    BeOutResp = 36,
    GetInningsInfoReq = 37,
    GetInningsInfoResp = 38,
}
...
export var gamecomm_packet_define = {
    ...
    24: new LeafWsPacket(24, gamecomm.InningInfo, "gamecomm.InningInfo"),
    ...
    37: new LeafWsPacket(37, gamecomm.GetInningsInfoReq, "gamecomm.GetInningsInfoReq"),
    38: new LeafWsPacket(38, gamecomm.GetInningsInfoResp, "gamecomm.GetInningsInfoResp"),
}
...
export class gamecomm_request {
    ...
    public static InningInfo( data:{ Number:string, Name:string, Level:number, Payoff:number, TimeStamp:number } ) { gamecomm_packet_define[24].sendToChannel(ChannelDefine.game, data, false); }
    ...
    public static GetInningsInfoReq( data:{ GameID:number } ) { gamecomm_packet_define[37].sendToChannel(ChannelDefine.game, data, false); }
    public static GetInningsInfoResp( data:{ Innings:any[], PageNum:number } ) { gamecomm_packet_define[38].sendToChannel(ChannelDefine.game, data, false); }
}
