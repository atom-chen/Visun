...
export class gamecomm_request {
    ...
    public static EnterGameReq( data:{ GameID:number, TableNum:number, Password:string } ) { gamecomm_packet_define[38].sendToChannel(ChannelDefine.game, data, false); }
    public static EnterGameResp( data:{ GameID:number, TableNum:number, UserInfo:any } ) { gamecomm_packet_define[39].sendToChannel(ChannelDefine.game, data, false); }
