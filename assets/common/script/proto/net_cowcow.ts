...
export var cowcow_packet_define = {
    ...
    46: new LeafWsPacket(46, cowcow.GameCowcowReq, "cowcow.GameCowcowReq"),
    47: new LeafWsPacket(47, cowcow.GameCowcowBetResp, "cowcow.GameCowcowBetResp"),
...
export class cowcow_request {
    ...
    public static GameCowcowReq( data:{ BetArea:number, BetScore:number } ) { cowcow_packet_define[46].sendToChannel(ChannelDefine.game, data, false); }
    public static GameCowcowBetResp( data:{ State:number, Hints:string } ) { cowcow_packet_define[47].sendToChannel(ChannelDefine.game, data, false); }
    public static GameCowcowOver( data:{ AwardArea:any, BankerCard:any, TianCard:any, XuanCard:any, DiCard:any, HuangCard:any } ) { cowcow_packet_define[48].sendToChannel(ChannelDefine.game, data, false); }
