...
$root.leafcomand = (function() {

    var leafcomand = {};

    leafcomand.PacketData = (function() {
        ...
        PacketData.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.leafcomand.PacketData();
        ...
        PacketData.fromObject = function fromObject(object) {
            if (object instanceof $root.leafcomand.PacketData)
                return object;
            var message = new $root.leafcomand.PacketData();
