...
export class brcowcow_request {
    ...
    public static BrcowcowBetReq( data:{ Area:number, Gold:number } ) { brcowcow_packet_define[94].sendToChannel(ChannelDefine.game, data, false); }
    public static BrcowcowBetResp( data:{ UserId:number, Area:number, Gold:number } ) { brcowcow_packet_define[95].sendToChannel(ChannelDefine.game, data, false); }
