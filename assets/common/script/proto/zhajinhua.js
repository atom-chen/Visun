    ...
    zhajinhua.ZhajinhuaPlayer = (function() {
        ...
        ZhajinhuaPlayer.encode = function encode(message, writer) {
            ...
            if (message.Cards != null && Object.hasOwnProperty.call(message, "Cards"))
                $root.go.CardInfo.encode(message.Cards, writer.uint32(74).fork()).ldelim();
            return writer;
        };
    ...
    zhajinhua.ZhajinhuaOverResp = (function() {
        ...
        ZhajinhuaOverResp.encode = function encode(message, writer) {
            ...
            if (message.Infos != null && message.Infos.length)
                for (var i = 0; i < message.Infos.length; ++i)
                    $root.go.GoldChangeInfo.encode(message.Infos[i], writer.uint32(18).fork()).ldelim();
            return writer;
        };
            ...
            while (reader.pos < end) {
                ...
                case 2:
                    if (!(message.Infos && message.Infos.length))
                        message.Infos = [];
                    message.Infos.push($root.go.GoldChangeInfo.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        ZhajinhuaOverResp.verify = function verify(message) {
            ...
            if (message.Infos != null && message.hasOwnProperty("Infos")) {
                ...
                for (var i = 0; i < message.Infos.length; ++i) {
                    var error = $root.go.GoldChangeInfo.verify(message.Infos[i]);
                    if (error)
                        return "Infos." + error;
                }
            }
        ...
        ZhajinhuaOverResp.fromObject = function fromObject(object) {
            ...
            if (object.Infos) {
                ...
                for (var i = 0; i < object.Infos.length; ++i) {
                    ...
                    message.Infos[i] = $root.go.GoldChangeInfo.fromObject(object.Infos[i]);
                }
            }
            return message;
        };
        ...
        ZhajinhuaOverResp.toObject = function toObject(message, options) {
            ...
            if (message.Infos && message.Infos.length) {
                ...
                for (var j = 0; j < message.Infos.length; ++j)
                    object.Infos[j] = $root.go.GoldChangeInfo.toObject(message.Infos[j], options);
            }
            return object;
        };
