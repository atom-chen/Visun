    ...
    zhajinhua.ZhajinhuaOver = (function() {
        ...
        ZhajinhuaOver.encode = function encode(message, writer) {
            ...
            if (message.Infos != null && message.Infos.length)
                for (var i = 0; i < message.Infos.length; ++i)
                    $root.gamecomm.MoneyCalculateInfo.encode(message.Infos[i], writer.uint32(18).fork()).ldelim();
            return writer;
        };
            ...
            while (reader.pos < end) {
                ...
                case 2:
                    if (!(message.Infos && message.Infos.length))
                        message.Infos = [];
                    message.Infos.push($root.gamecomm.MoneyCalculateInfo.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        ZhajinhuaOver.verify = function verify(message) {
            ...
            if (message.Infos != null && message.hasOwnProperty("Infos")) {
                ...
                for (var i = 0; i < message.Infos.length; ++i) {
                    var error = $root.gamecomm.MoneyCalculateInfo.verify(message.Infos[i]);
                    if (error)
                        return "Infos." + error;
                }
            }
        ...
        ZhajinhuaOver.fromObject = function fromObject(object) {
            ...
            if (object.Infos) {
                ...
                for (var i = 0; i < object.Infos.length; ++i) {
                    ...
                    message.Infos[i] = $root.gamecomm.MoneyCalculateInfo.fromObject(object.Infos[i]);
                }
            }
            return message;
        };
        ...
        ZhajinhuaOver.toObject = function toObject(message, options) {
            ...
            if (message.Infos && message.Infos.length) {
                ...
                for (var j = 0; j < message.Infos.length; ++j)
                    object.Infos[j] = $root.gamecomm.MoneyCalculateInfo.toObject(message.Infos[j], options);
            }
            return object;
        };
