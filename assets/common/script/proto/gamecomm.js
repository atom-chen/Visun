...
$root.gamecomm = (function() {
    ...
    gamecomm.ConfigInfo = (function() {
        ...
        ConfigInfo.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.gamecomm.ConfigInfo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        ConfigInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.gamecomm.ConfigInfo)
                return object;
            var message = new $root.gamecomm.ConfigInfo();
            if (object.Name != null)
                message.Name = String(object.Name);
            if (object.Key != null)
    ...
    gamecomm.SettingGameReq = (function() {
        ...
        SettingGameReq.encode = function encode(message, writer) {
            ...
            if (message.Info != null && Object.hasOwnProperty.call(message, "Info"))
                $root.gamecomm.ConfigInfo.encode(message.Info, writer.uint32(34).fork()).ldelim();
            return writer;
        };
        ...
        SettingGameReq.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.gamecomm.SettingGameReq();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 4:
                    message.Info = $root.gamecomm.ConfigInfo.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        SettingGameReq.verify = function verify(message) {
            ...
            if (message.Info != null && message.hasOwnProperty("Info")) {
                var error = $root.gamecomm.ConfigInfo.verify(message.Info);
                if (error)
                    return "Info." + error;
            }
            return null;
        ...
        SettingGameReq.fromObject = function fromObject(object) {
            if (object instanceof $root.gamecomm.SettingGameReq)
                return object;
            var message = new $root.gamecomm.SettingGameReq();
            switch (object.Model) {
            case "General":
            case 0:
                message.Model = 0;
            ...
            if (object.Info != null) {
                if (typeof object.Info !== "object")
                    throw TypeError(".gamecomm.SettingGameReq.Info: object expected");
                message.Info = $root.gamecomm.ConfigInfo.fromObject(object.Info);
            }
            return message;
        };
        ...
        SettingGameReq.toObject = function toObject(message, options) {
            ...
            if (message.Model != null && message.hasOwnProperty("Model"))
                object.Model = options.enums === String ? $root.gamecomm.GameModel[message.Model] : message.Model;
            if (message.KindID != null && message.hasOwnProperty("KindID"))
                object.KindID = message.KindID;
            if (message.Info != null && message.hasOwnProperty("Info"))
                object.Info = $root.gamecomm.ConfigInfo.toObject(message.Info, options);
            return object;
        };
    ...
    gamecomm.SettingGameResp = (function() {
        ...
        SettingGameResp.encode = function encode(message, writer) {
            ...
            if (message.Info != null && Object.hasOwnProperty.call(message, "Info"))
                $root.gamecomm.ConfigInfo.encode(message.Info, writer.uint32(26).fork()).ldelim();
            return writer;
        };
        ...
        SettingGameResp.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.gamecomm.SettingGameResp();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        SettingGameResp.fromObject = function fromObject(object) {
            if (object instanceof $root.gamecomm.SettingGameResp)
                return object;
            var message = new $root.gamecomm.SettingGameResp();
            if (object.GameID != null)
                message.GameID = object.GameID >>> 0;
            ...
            if (object.Info != null) {
                if (typeof object.Info !== "object")
                    throw TypeError(".gamecomm.SettingGameResp.Info: object expected");
                message.Info = $root.gamecomm.ConfigInfo.fromObject(object.Info);
            }
            return message;
        };
    ...
    gamecomm.EnterGameResp = (function() {
        ...
        EnterGameResp.encode = function encode(message, writer) {
            ...
            if (message.UserInfo != null && Object.hasOwnProperty.call(message, "UserInfo"))
                $root.gamecomm.PlayerInfo.encode(message.UserInfo, writer.uint32(18).fork()).ldelim();
            return writer;
        };
