...
export enum qzcowcow_msgs {
    ...
    QzcowcowCallReq = 190,
    QzcowcowCallResp = 191,
    QzcowcowBetReq = 192,
    QzcowcowBetResp = 193,
    QzcowcowOpenResp = 194,
    QzcowcowOverResp = 195,
}
...
export var qzcowcow_packet_define = {
    ...
    190: new LeafWsPacket(190, qzcowcow.QzcowcowCallReq, "qzcowcow.QzcowcowCallReq"),
    191: new LeafWsPacket(191, qzcowcow.QzcowcowCallResp, "qzcowcow.QzcowcowCallResp"),
    192: new LeafWsPacket(192, qzcowcow.QzcowcowBetReq, "qzcowcow.QzcowcowBetReq"),
    193: new LeafWsPacket(193, qzcowcow.QzcowcowBetResp, "qzcowcow.QzcowcowBetResp"),
    194: new LeafWsPacket(194, qzcowcow.QzcowcowOpenResp, "qzcowcow.QzcowcowOpenResp"),
    195: new LeafWsPacket(195, qzcowcow.QzcowcowOverResp, "qzcowcow.QzcowcowOverResp"),
}
...
export class qzcowcow_request {
    ...
    public static QzcowcowCallReq( data:{ Multiple:number } ) { qzcowcow_packet_define[190].sendToChannel(ChannelDefine.game, data, false); }
    public static QzcowcowCallResp( data:{ UserID:number, Multiple:number } ) { qzcowcow_packet_define[191].sendToChannel(ChannelDefine.game, data, false); }
    public static QzcowcowBetReq( data:{ BetArea:number, BetScore:number } ) { qzcowcow_packet_define[192].sendToChannel(ChannelDefine.game, data, false); }
    public static QzcowcowBetResp( data:{ UserId:number, BetArea:number, BetScore:number } ) { qzcowcow_packet_define[193].sendToChannel(ChannelDefine.game, data, false); }
    public static QzcowcowOpenResp( data:{ WinnerId:number, Infos:any[] } ) { qzcowcow_packet_define[194].sendToChannel(ChannelDefine.game, data, false); }
    public static QzcowcowOverResp( data:{ MySettlement:number, TotalSettlement:number[] } ) { qzcowcow_packet_define[195].sendToChannel(ChannelDefine.game, data, false); }
}
