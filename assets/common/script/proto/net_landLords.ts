...
export class landLords_request {
    public static GameLandLordsEnter( data:{ ChairID:number, TimeStamp:number, FreeTime:number, OutTime:number, CallTime:number, HandCards:any, Free:any, Start:any, Call:any, Playing:any, Over:any, BeforeChairID:number, BeforeCards:any } ) { landLords_packet_define[48].sendToChannel(ChannelDefine.game, data, false); }
