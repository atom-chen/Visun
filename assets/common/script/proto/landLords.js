    ...
    landLords.GameLandLordsEnter = (function() {
        ...
        GameLandLordsEnter.encode = function encode(message, writer) {
            ...
            if (message.Free != null && message.hasOwnProperty("Free"))
                $root.go.GameStateFree.encode(message.Free, writer.uint32(42).fork()).ldelim();
            if (message.Start != null && message.hasOwnProperty("Start"))
                $root.go.GameStateStart.encode(message.Start, writer.uint32(50).fork()).ldelim();
            if (message.Call != null && message.hasOwnProperty("Call"))
                $root.go.GameStateCall.encode(message.Call, writer.uint32(58).fork()).ldelim();
            if (message.Playing != null && message.hasOwnProperty("Playing"))
                $root.go.GameStatePlaying.encode(message.Playing, writer.uint32(66).fork()).ldelim();
            if (message.Over != null && message.hasOwnProperty("Over"))
                $root.go.GameStateOver.encode(message.Over, writer.uint32(74).fork()).ldelim();
        ...
        GameLandLordsEnter.decode = function decode(reader, length) {
            ...
            while (reader.pos < end) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    message.Free = $root.go.GameStateFree.decode(reader, reader.uint32());
                    break;
                case 6:
                    message.Start = $root.go.GameStateStart.decode(reader, reader.uint32());
                    break;
                case 7:
                    message.Call = $root.go.GameStateCall.decode(reader, reader.uint32());
                    break;
                case 8:
                    message.Playing = $root.go.GameStatePlaying.decode(reader, reader.uint32());
                    break;
                case 9:
                    message.Over = $root.go.GameStateOver.decode(reader, reader.uint32());
                    break;
                case 10:
        ...
        GameLandLordsEnter.verify = function verify(message) {
            ...
            if (message.Free != null && message.hasOwnProperty("Free")) {
                var error = $root.go.GameStateFree.verify(message.Free);
                if (error)
                    return "Free." + error;
            }
            if (message.Start != null && message.hasOwnProperty("Start")) {
                var error = $root.go.GameStateStart.verify(message.Start);
                if (error)
                    return "Start." + error;
            }
            if (message.Call != null && message.hasOwnProperty("Call")) {
                var error = $root.go.GameStateCall.verify(message.Call);
                if (error)
                    return "Call." + error;
            }
            if (message.Playing != null && message.hasOwnProperty("Playing")) {
                var error = $root.go.GameStatePlaying.verify(message.Playing);
                if (error)
                    return "Playing." + error;
            }
            if (message.Over != null && message.hasOwnProperty("Over")) {
                var error = $root.go.GameStateOver.verify(message.Over);
                if (error)
                    return "Over." + error;
            }
            if (message.BeforeChairID != null && message.hasOwnProperty("BeforeChairID"))
        ...
        GameLandLordsEnter.fromObject = function fromObject(object) {
            ...
            if (object.Free != null) {
                ...
                message.Free = $root.go.GameStateFree.fromObject(object.Free);
            }
            if (object.Start != null) {
                if (typeof object.Start !== "object")
                    throw TypeError(".landLords.GameLandLordsEnter.Start: object expected");
                message.Start = $root.go.GameStateStart.fromObject(object.Start);
            }
            if (object.Call != null) {
                if (typeof object.Call !== "object")
                    throw TypeError(".landLords.GameLandLordsEnter.Call: object expected");
                message.Call = $root.go.GameStateCall.fromObject(object.Call);
            }
            if (object.Playing != null) {
                ...
                message.Playing = $root.go.GameStatePlaying.fromObject(object.Playing);
            }
            if (object.Over != null) {
                if (typeof object.Over !== "object")
                    throw TypeError(".landLords.GameLandLordsEnter.Over: object expected");
                message.Over = $root.go.GameStateOver.fromObject(object.Over);
            }
        ...
        GameLandLordsEnter.toObject = function toObject(message, options) {
            ...
            if (message.Free != null && message.hasOwnProperty("Free"))
                object.Free = $root.go.GameStateFree.toObject(message.Free, options);
            if (message.Start != null && message.hasOwnProperty("Start"))
                object.Start = $root.go.GameStateStart.toObject(message.Start, options);
            if (message.Call != null && message.hasOwnProperty("Call"))
                object.Call = $root.go.GameStateCall.toObject(message.Call, options);
            if (message.Playing != null && message.hasOwnProperty("Playing"))
                object.Playing = $root.go.GameStatePlaying.toObject(message.Playing, options);
            if (message.Over != null && message.hasOwnProperty("Over"))
                object.Over = $root.go.GameStateOver.toObject(message.Over, options);
            if (message.BeforeChairID != null && message.hasOwnProperty("BeforeChairID"))
    ...
    go.GameStateFree = (function() {
        ...
        GameStateFree.fromObject = function fromObject(object) {
            if (object instanceof $root.go.GameStateFree)
                return object;
            return new $root.go.GameStateFree();
        };
    ...
    go.GameStateStart = (function() {
        ...
        GameStateStart.fromObject = function fromObject(object) {
            if (object instanceof $root.go.GameStateStart)
                return object;
            return new $root.go.GameStateStart();
        };
    ...
    go.GameStatePlaying = (function() {
        ...
        GameStatePlaying.fromObject = function fromObject(object) {
            if (object instanceof $root.go.GameStatePlaying)
                return object;
            return new $root.go.GameStatePlaying();
        };
    ...
    go.GameStateOver = (function() {
        ...
        GameStateOver.fromObject = function fromObject(object) {
            if (object instanceof $root.go.GameStateOver)
                return object;
            return new $root.go.GameStateOver();
        };
