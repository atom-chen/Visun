    ...
    landLords.GameLandLordsEnter = (function() {
        ...
        GameLandLordsEnter.encode = function encode(message, writer) {
            ...
            if (message.BeforeCards != null && message.hasOwnProperty("BeforeCards"))
                writer.uint32(50).bytes(message.BeforeCards);
            if (message.HandCards != null && message.hasOwnProperty("HandCards"))
                writer.uint32(58).bytes(message.HandCards);
            if (message.Free != null && message.hasOwnProperty("Free"))
                $root.gamecomm.GameStateFree.encode(message.Free, writer.uint32(66).fork()).ldelim();
            if (message.Start != null && message.hasOwnProperty("Start"))
                $root.gamecomm.GameStateStart.encode(message.Start, writer.uint32(74).fork()).ldelim();
            if (message.Call != null && message.hasOwnProperty("Call"))
                $root.gamecomm.GameStateCall.encode(message.Call, writer.uint32(82).fork()).ldelim();
            if (message.Playing != null && message.hasOwnProperty("Playing"))
                $root.gamecomm.GameStatePlaying.encode(message.Playing, writer.uint32(90).fork()).ldelim();
            if (message.Over != null && message.hasOwnProperty("Over"))
                $root.gamecomm.GameStateOver.encode(message.Over, writer.uint32(98).fork()).ldelim();
            return writer;
        };
