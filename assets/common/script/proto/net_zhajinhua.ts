...
export enum zhajinhua_msgs {
    ...
    ExitGameZjhResp = 104,
    ZhajinhuaSceneResp = 105,
    ZhajinhuaStateFreeResp = 106,
    ZhajinhuaStateStartResp = 107,
    ZhajinhuaStatePlayingResp = 108,
    ZhajinhuaStateCompareResp = 109,
    ZhajinhuaStateOverResp = 110,
...
export var zhajinhua_packet_define = {
    ...
    104: new LeafWsPacket(104, zhajinhua.ExitGameZjhResp, "zhajinhua.ExitGameZjhResp"),
    105: new LeafWsPacket(105, zhajinhua.ZhajinhuaSceneResp, "zhajinhua.ZhajinhuaSceneResp"),
    106: new LeafWsPacket(106, zhajinhua.ZhajinhuaStateFreeResp, "zhajinhua.ZhajinhuaStateFreeResp"),
    107: new LeafWsPacket(107, zhajinhua.ZhajinhuaStateStartResp, "zhajinhua.ZhajinhuaStateStartResp"),
    108: new LeafWsPacket(108, zhajinhua.ZhajinhuaStatePlayingResp, "zhajinhua.ZhajinhuaStatePlayingResp"),
    109: new LeafWsPacket(109, zhajinhua.ZhajinhuaStateCompareResp, "zhajinhua.ZhajinhuaStateCompareResp"),
    110: new LeafWsPacket(110, zhajinhua.ZhajinhuaStateOverResp, "zhajinhua.ZhajinhuaStateOverResp"),
...
export class zhajinhua_request {
    public static ZhajinhuaPlayer( data:{ MyInfo:any, IsSee:any, RecentScore:number, TotalScore:number, Cards:any } ) { zhajinhua_packet_define[102].sendToChannel(ChannelDefine.game, data, false); }
    public static EnterGameZjhResp( data:{ Player:any } ) { zhajinhua_packet_define[103].sendToChannel(ChannelDefine.game, data, false); }
    public static ExitGameZjhResp( data:{ UserId:number } ) { zhajinhua_packet_define[104].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaSceneResp( data:{ TimeStamp:number, TotalScore:number, MinScore:number, Banker:number, Fighters:any[], Inning:string } ) { zhajinhua_packet_define[105].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaStateFreeResp( data:{ Times:any } ) { zhajinhua_packet_define[106].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaStateStartResp( data:{ Times:any } ) { zhajinhua_packet_define[107].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaStatePlayingResp( data:{ Times:any, UserID:number } ) { zhajinhua_packet_define[108].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaStateCompareResp( data:{ Times:any, Info:any } ) { zhajinhua_packet_define[109].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaStateOverResp( data:{ Times:any, WinnerId:number } ) { zhajinhua_packet_define[110].sendToChannel(ChannelDefine.game, data, false); }
    ...
    public static ZhajinhuaLookResp( data:{ UserId:number } ) { zhajinhua_packet_define[120].sendToChannel(ChannelDefine.game, data, false); }
