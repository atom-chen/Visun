...
export var zhajinhua_packet_define = {
    91: new LeafWsPacket(91, zhajinhua.FighterInfo, "zhajinhua.FighterInfo"),
    92: new LeafWsPacket(92, zhajinhua.ZhajinhuaScene, "zhajinhua.ZhajinhuaScene"),
...
export class zhajinhua_request {
    public static FighterInfo( data:{ UserId:number, SeatId:number, FightState:number, IsSee:any, RecentBetMoney:number, TotalBetMoney:number, Cards:any } ) { zhajinhua_packet_define[91].sendToChannel(ChannelDefine.game, data, false); }
    public static ZhajinhuaScene( data:{ TimeStamp:number, TotalBet:number, MinBet:number, CurHost:number, Fighters:any[] } ) { zhajinhua_packet_define[92].sendToChannel(ChannelDefine.game, data, false); }
    ...
    public static ZhajinhuaReadyReq( data:{ IsReady:any } ) { zhajinhua_packet_define[98].sendToChannel(ChannelDefine.game, data, false); }
