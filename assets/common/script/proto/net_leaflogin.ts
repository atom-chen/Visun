...
export var leaflogin_packet_define = {
    20000: new LeafPacket(20000, leaflogin.Register, 200, 101),
    20001: new LeafPacket(20001, leaflogin.RegisterResult, 200, 101),
    20002: new LeafPacket(20002, leaflogin.Login, 201, 101),
    20003: new LeafPacket(20003, leaflogin.ResResult, 201, 101),
}
